//
//  MXRFloatContainerViewController.m
//  huashida_home
//
...
@interface MXRFloatContainerViewController ()

@end

CGFloat MXRFloatRoundPixelValue(CGFloat value)
{
    CGFloat scale = [[UIScreen mainScreen] scale];
    return roundf(value * scale) / scale;
}

@implementation MXRFloatContainerViewController
{
    UIViewController<MXRFloatMovableViewController> *_presentedViewController;
...
- (void)presentViewController:(UIViewController<MXRFloatMovableViewController> *)viewController
                     withSize:(CGSize)size
{
    ...
    CGFloat widthOffset = MXRFloatRoundPixelValue((CGRectGetWidth(self.view.bounds) - adjustedSize.width) / 2.0);
...
- (void)_pan
{
    ...
    CGFloat centerHeightOffset = MXRFloatRoundPixelValue(CGRectGetHeight(_presentedViewController.view.frame) / 2.0);
    CGFloat centerWidthOffset = MXRFloatRoundPixelValue(CGRectGetWidth(_presentedViewController.view.frame) / 2.0);
...
- (void)_pinch:(UIPinchGestureRecognizer *)gestureRecognizer
{
    ...
    CGFloat yOffset = MXRFloatRoundPixelValue((expectedHeight - CGRectGetHeight(_presentedViewController.view.frame)) / 2.0);
